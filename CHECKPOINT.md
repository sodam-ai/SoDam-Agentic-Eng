...
> **다음 세션은 이 파일을 먼저 읽고 이어가면 됩니다.** 기준일: 2026-06-23.
...
2. ⬜ **AGENTS.md + CLAUDE.md 포인터** (공유 코어 지침, ≤150줄, 군살 금지).
3. ⬜ **Codex 설치** `codex/install.mjs` ("두 도구" 차별점의 절반).
4. ⬜ **master/main 정식 브랜치 정리** (현재 원격은 init-mvp만).
5. ⬜ LICENSE 파일(라이선스 확정 후) · 비개발자 베타.
